...
extension Profile {
    static let profileStub01: Profile = .init(nickname: "Soop", image: "Soop", tags: ["위시 좋아해요💚", "운동", "기숙사🛏️", "반가워요"], description: "안녕하세요! 저는 Soop입니다.", isOpened: true, comments: [.init(text: "숩 파이팅", backgroundColor: .memoBlue)])
    static let profileStub02: Profile = .init(nickname: "Ian", image: "Ian", tags: ["위시 좋아해요💚", "운동", "기숙사🛏️", "반가워요"], description: "안녕하세요! 저는 Ian입니다.", isOpened: true, comments: [.init(text: "숩 파이팅", backgroundColor: .memoBlue)])
    static let profileStub03: Profile = .init(nickname: "Rohd", image: "Rohd", tags: ["위시 좋아해요💚", "운동", "기숙사🛏️", "반가워요"], description: "안녕하세요! 저는 Ian입니다.", isOpened: true, comments: [.init(text: "숩 파이팅", backgroundColor: .memoBlue)])
    static let profileStub04: Profile = .init(nickname: "Weaver", image: "Weaver", tags: ["위시 좋아해요💚", "운동", "기숙사🛏️", "반가워요"], description: "안녕하세요! 저는 Weaver입니다.", isOpened: true, comments: [.init(text: "숩 파이팅", backgroundColor: .memoBlue)])
    static let profileStub05: Profile = .init(nickname: "Zani", image: "Zani", tags: ["위시 좋아해요💚", "운동", "기숙사🛏️", "반가워요"], description: "안녕하세요! 저는 Zani입니다.", isOpened: true, comments: [.init(text: "숩 파이팅", backgroundColor: .memoBlue)])
